...
class Multicolumn_Listbox(object):
    ...
    def __init__(self, master, columns, data=None, command=None, sort=True, select_mode=None, heading_anchor=CENTER,
                 cell_anchor=W, style=None, height=15, padding=None, adjust_heading_to_content=True,
        ...
        self.interior = Treeview(master, columns=columns, **treeview_kwargs, selectmode='browse')
