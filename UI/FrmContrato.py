...
class FrmContrato():
    ...
    def janela_proprietario(self):
        if self.jan == None:
            ...
            self.ePorAdmin = Entry(self.porcAdmin, width=3, validate="key", validatecommand=(self.validate, "%P", 2))
    ...
    def __init__(self, conteudoFrame):
        ...
        self.propMc.configure_column(3, stretch=False, minwidth=450, width=450)
        self.propMc.configure_column(4, stretch=False, minwidth=100, width=100)
        ...
        self.propMc.configure_column(7, stretch=False, minwidth=55, width=55)
        self.propMc.configure_column(8, stretch=False, minwidth=100, width=100)
        self.propMc.configure_column(9, stretch=False, minwidth=80, width=80)
        self.propMc.configure_column(10, stretch=True, minwidth=450, width=450)
